...
% run_overlap_dv_tmax_sweep.m (OOM-safe, no full atlas broadcast).
%
% Strategy:
...
%
% Outputs written to <out_root>/<tag>/overlap_pairs_13fam/Summary/:
...
%   run_overlap_pair_visuals.m  (separate heavy pipeline).
...
% ── Output directories ───────────────────────────────────────────────────────
batchTag   = sprintf('overlap_pairs_%dfam', N);
...
% MAT workspace (compatible with run_overlap_dv_tmax_sweep.m scanner)
...
% ════════════════════════════════════════════════════════════════════════════
%  LOCAL FUNCTIONS  (identical to run_overlap_dv_tmax_sweep.m)
% ════════════════════════════════════════════════════════════════════════════
