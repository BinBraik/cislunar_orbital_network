...
%   2. Compute overlap O and voxel metadata V (same as run_overlap_pair_visuals)
%   3. Run overlap_visualize_bounds to get B struct (best voxel index B.imin)
%   4. Call overlap_voxel_traj_extract  -> T struct with arcs + true DV values
%   5. Call overlap_voxel_traj_visualize -> cislunar background plot
%
...
% ===================== PLOT (original arcs) =====================
overlap_voxel_traj_visualize(T, SA, SB, cfg, outdir, tag);
...
% ===================== COMPARISON PLOT =====================
traj_diffcorr_visualize(T, Tc, SA, SB, cfg, outdir, tag);
