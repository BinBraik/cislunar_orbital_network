...
if doXY
    ...
    io_save_figure(fig, outdir, ['overlap_' safeTag '_overlap_xy'], cfg, 'Resolution', local_fig_res(cfg));
...
if doXYZ
    ...
    io_save_figure(fig, outdir, ['overlap_' safeTag '_overlap_xyz'], cfg, 'Resolution', local_fig_res(cfg));
    local_close_if_hidden(cfg, fig);
end
