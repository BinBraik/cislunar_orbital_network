...
%
% Inputs
%   T    : T or Tc struct (overlap_voxel_traj_extract / traj_diffcorr)
%   traj : full-trajectory struct from traj_build_full(T)
...
io_save_figure(fig, outdir, ['traj_' safeTag], cfg);
end

% =========================================================================
% Local helpers  (mirrored from overlap_voxel_traj_visualize)
% =========================================================================
