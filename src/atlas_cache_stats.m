...
% hit table sizes
if isfield(S,'Step4')
    st.rows_FRS_upper = atlas_rows_count(S.Step4.rows_FRS_upper);
    st.rows_FRS_lower = atlas_rows_count(S.Step4.rows_FRS_lower);
    ...
    st.uv_FRS_upper = numel(unique(atlas_rows_to_voxelid(S.Step4.rows_FRS_upper, S.grid3)));
    st.uv_FRS_lower = numel(unique(atlas_rows_to_voxelid(S.Step4.rows_FRS_lower, S.grid3)));
