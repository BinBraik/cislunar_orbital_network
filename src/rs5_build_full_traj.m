function traj = rs5_build_full_traj(T)
...
%
% Works with both:
%   T  — uncorrected struct from rs4_voxel_traj_extract
%   Tc — corrected  struct from rs4_diffcorr
%
...
traj.arrive_th = rs3_wrapToPi(th_B(1) + pi);
