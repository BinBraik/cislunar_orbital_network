...
%
% Inputs
%   T      : struct from overlap_voxel_traj_extract     (before DC)
%   Tc     : struct from traj_diffcorr               (after  DC)
...
io_save_figure(fig, outdir, ['overlap_' safeTag '_diffcorr_compare'], cfg);
end
